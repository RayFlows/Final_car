...
def main():
    ...
    if cfg.TEST.MODEL_FILE:
        ...
        model_p.load_state_dict(torch.load(cfg.TEST.MODEL_FILE, map_location=torch.device("cpu")), strict=False)
    ...
    model_p = model_p.to(device)     # ② 模型放到 CPU
